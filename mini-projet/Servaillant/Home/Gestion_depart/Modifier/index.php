...
<?php
    ...
    if(isset($_POST["sub"]))
    {
        ...
        {
            $sql = "UPDATE `departement` SET `nom_depart`='".$salle."' WHERE id_depart = ".$id.";";
...
<body>
    ...
    <form action="index.php" method="post">
        <div class="modif">
            <p>Modifier un departement</p>
            <table>
                <tr>
                    <td> <label for="">Ancien departement</label></td> 
                    <td>
                ...
                <tr>
                    <td>Nouveau departement</td> <td><input type="text" name="nv_dept"> </td> <td><?php  echo $out_dep; ?> </td>
                </tr>
